...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            ...
            <p class="text-gray-500 dark:text-gray-400 text-sm">Manage deposit payment methods for users.</p>
        </div>
                ...
                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-400 max-w-xs truncate">
                            ...
                            {{ $method->wallet_address ? Str::limit($method->wallet_address, 30) : '—' }}
                            @else
                    ...
                    <tr>
                        <td colspan="6" class="px-6 py-12 text-center">
                            <p class="text-sm text-gray-500 dark:text-gray-400">No payment methods yet.</p>
                            <a href="{{ route('admin.payment-methods.create') }}"
                                class="text-sm text-black dark:text-white font-medium underline mt-1 inline-block">Add
                                your first method</a>
                        </td>
                    </tr>
                    @endforelse
